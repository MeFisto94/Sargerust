    ...
    pub fn parse_asset<R: Read>(rdr: &mut R) -> Result<WDTAsset, ParserError> {
        ...
        if mver.version != 18 {
            return Err(ParserError::FormatError {
                reason: "Unknown MVER Version: 18",
            });
        }
